...
public class QMemberAgree extends EntityPathBase<MemberAgree> {
    ...
    private static final long serialVersionUID = -1084353592L;
    ...
    public final com.umc.umcstudy.domain.entity.QTerms terms;
    ...
    public QMemberAgree(Class<? extends MemberAgree> type, PathMetadata metadata, PathInits inits) {
        ...
        this.terms = inits.isInitialized("terms") ? new com.umc.umcstudy.domain.entity.QTerms(forProperty("terms")) : null;
    }
