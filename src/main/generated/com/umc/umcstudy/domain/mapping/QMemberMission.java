...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -563000408L;
    ...
    public final com.umc.umcstudy.domain.entity.QMember member;

    public final com.umc.umcstudy.domain.entity.QMission mission;

    public final EnumPath<com.umc.umcstudy.domain.enums.MissionStatus> status = createEnum("status", com.umc.umcstudy.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.umc.umcstudy.domain.entity.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new com.umc.umcstudy.domain.entity.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
